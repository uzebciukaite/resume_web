...
const Home = () => {
  return (
    <Container id="home" className='about d-flex flex py-5 home '>
        ...
        excited to start my career in software engineering, optimise my coding skills and apply best practises to achieve top result.
        </p>
