...
const SingleResumeBox = ({x, Icon}) => {
  return (
    ...
    <div className='w-100 d-flex border-start border-5 border-light singleDescription '>
      ...
      <div className='py-5  w-65 d-flex flex-column text-start gap-4 rounded-end singleArea'>
      {x.areas.map(area => (
